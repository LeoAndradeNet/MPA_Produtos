...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    mPAProdutosAuthUserSubject.add(
      MPAProdutosAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MPAProdutosAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MPAProdutosAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MPAProdutosAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    mPAProdutosAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
MPAProdutosAuthUser? currentUser;
