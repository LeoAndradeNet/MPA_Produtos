          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                FFButtonWidget(
                  onPressed: () async {
                    _model.apiResultAddProduto =
                        await ProductCatalogAPIGroup.addProductRecordCall.call(
                      bearerAuth: currentAuthenticationToken,
                      name: _model.txtNomeTextController.text,
                    );

                    if ((_model.apiResultAddProduto?.succeeded ?? true)) {
                      _model.apiResulto5u =
                          await ProductCatalogAPIGroup.uploadImageCall.call(
                        productId: getJsonField(
                          (_model.apiResultAddProduto?.jsonBody ?? ''),
                          r'''$.id''',
                        ),
                      ...
                      if ((_model.apiResulto5u?.succeeded ?? true)) {
